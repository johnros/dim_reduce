...
A related problem is the one of choosing the dimension of the approximating space, $q$. 
The theory in \cite{nadler2008finite}, and \cite{gavish_optimal_2013} is a good starting point for an analytic solution.
Then again, a purely algorithmic solution is available by adopting the supervised learning view of dimensionality reduction.
As can be seen from Eq.(\ref{eq:pca-dim-reduce}), PCA, or any other reduction algorithm, is an empirical risk minimization problem.
