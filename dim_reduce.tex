...
The embedding is merely the assigning of each point to a location in some lower dimensional linear $\manifold$. 
The assignment is driven by a \emph{stress function} which penalizes for the distortion created by the embedding.
